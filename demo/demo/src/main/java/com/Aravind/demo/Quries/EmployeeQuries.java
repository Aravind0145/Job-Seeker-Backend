...
public class EmployeeQuries {
  ...
  public static final String UpdateEmployee =
          "UPDATE Employee e " +
                  ...
                  "e.profilePhoto = :profilePhoto, " +  // Corrected comma
                  "e.designation = :designation, " +
                  "e.password = :password, " +
                  "e.role = :role " +  // Removed unnecessary comma here
                  "WHERE e.id = :id";
  ...
  public static final String applicationstatus=
          "SELECT COUNT(*) FROM Applications WHERE jobSeeker.id = :jobSeekerId AND jobPosting.id = :jobPostingId";
